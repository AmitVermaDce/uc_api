...
from src.uc_api.entity import SummarizerDataIngestionConfig
...
class DataIngestion:
    ...
    def convert_csv_to_train_and_test_datasets(self):
        ...
        try:
            ...
            selected_file = [
                filename for filename in filenames if filename.endswith(suffix) and filename.__contains__("news_summary.csv")
            ][0]
